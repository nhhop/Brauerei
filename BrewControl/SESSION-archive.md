# BrewControl Session-Archiv

Ausgelagerte, abgeschlossene Session-Einträge aus [`SESSION.md`](SESSION.md) —
dort steht der aktuelle Stand; hier die Detail-Historie zu zwei in sich
abgeschlossenen Strängen, unverändert übernommen.
