// Generated by lv_font_conv - see README.md in this folder. Only the
// display build has LVGL, hence the guard.
#ifdef BREWCTL_HAS_DISPLAY

/*******************************************************************************
 * Size: 64 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --bpp 4 --size 64 --format lvgl --lv-include lvgl.h --font lvgl/scripts/built_in_font/Montserrat-Medium.ttf --symbols 0123456789 +-.,:% -o src/display/fonts/brew_font_64.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1150, .adv_w = 596, .box_w = 29, .box_h = 28, .ofs_x = 4, .ofs_y = 8},
    {.bitmap_index = 1556, .adv_w = 232, .box_w = 9, .box_h = 18, .ofs_x = 3, .ofs_y = -9},
    {.bitmap_index = 1637, .adv_w = 392, .box_w = 18, .box_h = 6, .ofs_x = 3, .ofs_y = 15},
    {.bitmap_index = 1691, .adv_w = 232, .box_w = 10, .box_h = 9, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1736, .adv_w = 683, .box_w = 37, .box_h = 47, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 2606, .adv_w = 379, .box_w = 17, .box_h = 45, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2989, .adv_w = 588, .box_w = 35, .box_h = 46, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3794, .adv_w = 586, .box_w = 34, .box_h = 46, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 4576, .adv_w = 685, .box_w = 41, .box_h = 45, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 5499, .adv_w = 588, .box_w = 34, .box_h = 46, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 6281, .adv_w = 632, .box_w = 35, .box_h = 47, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 7104, .adv_w = 612, .box_w = 35, .box_h = 45, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7892, .adv_w = 659, .box_w = 37, .box_h = 47, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 8762, .adv_w = 632, .box_w = 36, .box_h = 47, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 9608, .adv_w = 232, .box_w = 10, .box_h = 34, .ofs_x = 2, .ofs_y = 0}
};
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t brew_font_64 = {
#else
lv_font_t brew_font_64 = {
#endif
